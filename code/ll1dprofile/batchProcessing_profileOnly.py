...
parser.add_argument("--input", default="/paraview_files_artificial/", help="input paraview file folder")
parser.add_argument("--output", default="/1dprofiletool/api/mongodb_util/basin_points_profileOnly/", help="output file folder")
