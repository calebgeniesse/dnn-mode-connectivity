# Downloaded from https://github.com/trneedham/Decorated-Merge-Trees
...
class MergeTree:
    ...
    def draw(self, axes = False, **kwargs):

        draw_merge_tree(self.tree,self.height,axes = axes, **kwargs)

    # For merge trees coming from a network
    def draw_network(self):

        draw_network_and_function(self.network,self.filtration)

    def draw_network_with_merge_tree(self):

        draw_network_and_merge_tree(self.network,self.filtration)
